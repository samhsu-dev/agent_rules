---
description: Task management standards for todo.md files
---

# Task Management Standards

## Required TODO Structure
The following content MAY appear in todo.md.
...
- `- [ ] Add logging only where necessary (no redundant/trivial logs)`
...
### Phase Structure
- Use explicit phases in todo files when work spans multiple steps. Title phases as `[state] Phase N <action verb> <object> <detail>`.
- Each phase must include its own Depends on and Acceptance lines.
- Each phase must include the full Phase Completion Checklist subtasks.
- Keep phases sequential; later phases must depend on earlier ones.
